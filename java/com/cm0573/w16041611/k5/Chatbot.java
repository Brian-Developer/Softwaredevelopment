...
public class Chatbot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView sendBtn = findViewById(R.id.btn_send);
        sendBtn.setOnClickListener(this::sendMessage);

        queryEditText = findViewById(R.id.text_send);
    ...
    public void initChatBot(){
        final AIConfiguration config = new AIConfiguration("0a0cd534f00942c8894f04a3846c7dcd",
